...
private:
    ...
    std::atomic<bool> pendingBlock_;  // уже послали запрос на скачивание части файла и ждем ответ
    std::atomic<bool> failed_ = false;  // соединение не удалось установить или оно было разорвано в результате ошибки
